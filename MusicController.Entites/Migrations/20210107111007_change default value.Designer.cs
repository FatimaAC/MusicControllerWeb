...
namespace MusicController.Entites.Migrations
{
    ...
    [Migration("20210107111007_change default value")]
            ...
            modelBuilder.Entity("MusicController.Entites.Models.Outlet", b =>
                {
                    ...
                    b.Property<string>("Password")
                        ...
                        .HasColumnType("nvarchar(256)")
                        .HasMaxLength(256)
                        .HasDefaultValue("ZNtgmw/aIxxfnrPmMlGWJ+PjM8ifiqTLsNoXba/oz4w=");

                    b.Property<byte[]>("Salt")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varbinary(max)")
                        .HasDefaultValue(new byte[] { 78, 229, 18, 75, 149, 210, 104, 120, 45, 167, 210, 117, 178, 174, 147, 8 });
