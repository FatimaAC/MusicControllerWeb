...
namespace MusicController.Entites.Migrations
{
    ...
    [Migration("20210107124841_outlet password and salt values")]
    partial class outletpasswordandsaltvalues
    {
            ...
            modelBuilder.Entity("MusicController.Entites.Models.Outlet", b =>
                {
                    ...
                    b.Property<string>("Password")
                        ...
                        .HasColumnType("nvarchar(256)")
                        .HasMaxLength(256)
                        .HasDefaultValue("GJ8KvGdjh5y4zEgxGz5/Zu1ux1SYZpeOHadFAVzToJs=");

                    b.Property<byte[]>("Salt")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varbinary(max)")
                        .HasDefaultValue(new byte[] { 63, 8, 161, 89, 134, 118, 105, 20, 236, 201, 120, 115, 236, 97, 184, 35 });
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Baladna",
                            Password = "3/1yhAnpv+bF3jUO5X2WvjDfz0RycixokdrRbHl6Twc=",
                            Salt = new byte[] { 53, 218, 106, 100, 59, 241, 192, 221, 18, 219, 233, 53, 169, 62, 224, 15 }
                        },
                        new
                        {
                            Id = 2L,
