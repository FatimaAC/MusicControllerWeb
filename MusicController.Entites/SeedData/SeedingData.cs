    ...
    public static class SeedingData
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            new Outlet { Id = 1, Name = "Baladna", ImageUrl = "Images/Baladna.png" },
                ...
                new Outlet { Id = 13, Name = "Remman Cafe", ImageUrl = "Images/Remman Cafe.png" },
                new Outlet { Id = 14, Name = "Sazeli Logo", ImageUrl = "Images/Sazeli Logo.png" },
                new Outlet { Id = 15, Name = "SMAT", ImageUrl = "Images/SMAT.png" },
                new Outlet { Id = 16, Name = "USTA", ImageUrl = "Images/USTA.png" },
                new Outlet { Id = 17, Name = "USTA Remove", ImageUrl = "Images/USTA.png" }
           );
        }
    }
}
